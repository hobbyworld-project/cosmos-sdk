...
var (
	...
	fd_Params_min_bond_amount     protoreflect.FieldDescriptor
	fd_Params_max_bond_amount     protoreflect.FieldDescriptor
	fd_Params_enable_evm          protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_min_bond_amount = md_Params.Fields().ByName("min_bond_amount")
	fd_Params_max_bond_amount = md_Params.Fields().ByName("max_bond_amount")
	fd_Params_enable_evm = md_Params.Fields().ByName("enable_evm")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MinBondAmount != "" {
		value := protoreflect.ValueOfString(x.MinBondAmount)
		if !f(fd_Params_min_bond_amount, value) {
			return
		}
	}
	if x.MaxBondAmount != "" {
		value := protoreflect.ValueOfString(x.MaxBondAmount)
		if !f(fd_Params_max_bond_amount, value) {
			return
		}
	}
	if x.EnableEvm != false {
		value := protoreflect.ValueOfBool(x.EnableEvm)
		if !f(fd_Params_enable_evm, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.Params.min_bond_amount":
		return x.MinBondAmount != ""
	case "cosmos.staking.v1beta1.Params.max_bond_amount":
		return x.MaxBondAmount != ""
	case "cosmos.staking.v1beta1.Params.enable_evm":
		return x.EnableEvm != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.Params.min_bond_amount":
		x.MinBondAmount = value.Interface().(string)
	case "cosmos.staking.v1beta1.Params.max_bond_amount":
		x.MaxBondAmount = value.Interface().(string)
	case "cosmos.staking.v1beta1.Params.enable_evm":
		x.EnableEvm = value.Bool()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.Params.min_bond_amount":
		panic(fmt.Errorf("field min_bond_amount of message cosmos.staking.v1beta1.Params is not mutable"))
	case "cosmos.staking.v1beta1.Params.max_bond_amount":
		panic(fmt.Errorf("field max_bond_amount of message cosmos.staking.v1beta1.Params is not mutable"))
	case "cosmos.staking.v1beta1.Params.enable_evm":
		panic(fmt.Errorf("field enable_evm of message cosmos.staking.v1beta1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.MinBondAmount)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.MaxBondAmount)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.EnableEvm {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.MaxBondAmount) > 0 {
			i -= len(x.MaxBondAmount)
			copy(dAtA[i:], x.MaxBondAmount)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MaxBondAmount)))
			i--
			dAtA[i] = 0x42
		}
		if len(x.MinBondAmount) > 0 {
			i -= len(x.MinBondAmount)
			copy(dAtA[i:], x.MinBondAmount)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MinBondAmount)))
			i--
			dAtA[i] = 0x3a
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MinBondAmount", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.MinBondAmount = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 8:
				if wireType != 2 {
				...
				x.MaxBondAmount = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 9:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field EnableEvm", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
type Params struct {
	...
	MinBondAmount string `protobuf:"bytes,7,opt,name=min_bond_amount,json=minBondAmount,proto3" json:"min_bond_amount,omitempty"`
	// min_bond_amount is the max bond amount of staking tokens as a validator
	MaxBondAmount string `protobuf:"bytes,8,opt,name=max_bond_amount,json=maxBondAmount,proto3" json:"max_bond_amount,omitempty"`
...
func (x *Params) GetMaxBondAmount() string {
	if x != nil {
		return x.MaxBondAmount
	}
	return ""
...
func (x *Params) GetEnableEvm() bool {
	if x != nil {
		return x.EnableEvm
	}
	return false
...
var file_cosmos_staking_v1beta1_staking_proto_rawDesc = []byte{
	...
	0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x9a, 0x05, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	,
	...
	0x61, 0x6d, 0x73, 0x22, 0xad, 0x01, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69,
	...
	0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x3a, 0x08, 0x98, 0xa0, 0x1f, 0x00, 0xe8,
