...
type Params struct {
	...
	// burn_address defines the validator address who receives the rewards
	BurnAddress string `protobuf:"bytes,6,opt,name=burn_address,json=burnAddress,proto3" json:"burn_address,omitempty"`
}
...
func (m *Params) GetBurnAddress() string {
	if m != nil {
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.BurnAddress != that1.BurnAddress {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BurnAddress) > 0 {
		...
		i = encodeVarintDistribution(dAtA, i, uint64(len(m.BurnAddress)))
		i--
		dAtA[i] = 0x32
	}
